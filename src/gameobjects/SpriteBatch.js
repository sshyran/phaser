...
/**
* The SpriteBatch class is a really fast version of the Container built purely for speed, so use when you need a lot of sprites or particles.
...
* @param {Phaser.Group|Phaser.Sprite|null} parent - The parent Group, DisplayObject or Container that this Group will be added to. If `undefined` or `null` it will use game.world.
